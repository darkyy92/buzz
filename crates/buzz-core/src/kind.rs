...
/// Metadata-only NIP-14 title update for a stream-message thread.
///
/// This is deliberately distinct from kind:40003 message edits so clients
/// that only understand body edits cannot mistake an empty title event for an
/// instruction to erase the message body.
pub const KIND_STREAM_THREAD_TITLE: u32 = 40009;
